 ...
 * generated in the xyz.meistertobias.soap.client.gen.calc package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://server.soap.meistertobias.xyz/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://server.soap.meistertobias.xyz/", "addResponse");
    private final static QName _Divide_QNAME = new QName("http://server.soap.meistertobias.xyz/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://server.soap.meistertobias.xyz/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://server.soap.meistertobias.xyz/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://server.soap.meistertobias.xyz/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://server.soap.meistertobias.xyz/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://server.soap.meistertobias.xyz/", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: xyz.meistertobias.soap.client.gen.calc
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "divide")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "divideResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "multiply")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "multiplyResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "subtract")
     ...
     */
    @XmlElementDecl(namespace = "http://server.soap.meistertobias.xyz/", name = "subtractResponse")
