 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://server.soap.meistertobias.xyz/", wsdlLocation = "http://127.0.0.1:8555/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://server.soap.meistertobias.xyz/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8555/user?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://server.soap.meistertobias.xyz/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.meistertobias.xyz/", "UserServicePort"), UserService.class, features);
    }
